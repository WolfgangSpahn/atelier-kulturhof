...
![Beispiel: bank (Geldinstitut), bank (Ufer)](images/meaning of bank.webp){width="95%" .gray-border}
...
![Beispiel: river, bank](images/context of bank.webp){width="95%" .gray-border}
...
![](images/KI Mensch Zusammenarbeit.webp){width="175%"}
...
Ist das eine wahrscheinliche Entwicklung?
...
- GTP Tutor Gruppen sind gleich wie die traditionelle Gruppe
...
:::
::: {.column width="50%"}
![](images/ITS_Architekture.webp){width="100%"}
:::
::::
